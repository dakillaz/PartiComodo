namespace Xlns.PartiComodo.ConfigurationManager
{
    ...
    public class Configurator : XmlConfigurationManager
    {
        ...
        public string messagesPartecipaMessage { get { return base.getParameter("helpers.messages.partecipazioneMessage"); } }
        public string messagesRimuoviMessage { get { return base.getParameter("helpers.messages.rimuoviPartecipazioneMessage"); } }
